...
/* ── Fixed toast — perfectly responsive, always below navbar ── */
  ...
  return (
    <>
      <style>{`
        ...
        .toast-inner.toast-error   { border: 1px solid rgba(239,68,68,0.4);  background: rgba(20,5,5,0.95);  }
        .toast-inner.toast-success { border: 1px solid rgba(57,255,20,0.4);  background: rgba(5,20,10,0.95); }
        .toast-icon  { font-size: 1.2rem; margin-top: 1px; flex-shrink: 0; line-height: 1; }
        .toast-body  { flex: 1; min-width: 0; }
        .toast-label { font-weight: 700; font-size: 0.82rem; margin-bottom: 0.2rem; font-family: 'Share Tech Mono', monospace; letter-spacing: 0.08em; }
        .toast-label.toast-error   { color: #f87171; }
        .toast-label.toast-success { color: #39ff14; }
        .toast-message { font-size: 0.78rem; color: rgba(255,255,255,0.7); font-family: 'Share Tech Mono', monospace; line-height: 1.5; word-break: break-word; overflow-wrap: break-word; }
        .toast-close { background: none; border: none; color: rgba(255,255,255,0.4); cursor: pointer; font-size: 1rem; padding: 0; line-height: 1; flex-shrink: 0; transition: color 0.15s; }
      ...
      <div className="toast-wrapper">
        <div className={`toast-inner toast-${type}`}>
          ...
          <div className="toast-body">
            <div className={`toast-label toast-${type}`}>{type === "error" ? "// ERROR" : "// SUCCESS"}</div>
    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          .login-container { padding: 5rem 1rem; }
